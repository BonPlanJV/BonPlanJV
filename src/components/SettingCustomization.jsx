      ...
      <div className="flex space-x-10">
        <div className="flex flex-col space-y-5 w-[40%]">
          ...
          {user?.providerId === "google.com" && (
            ...
            >
              You are connected with Google, <br />
              you can&apos;t change your picture.
            </div>
          )}
          <a
            onClick={imgUpload}
        ...
        <div className="w-full space-y-5">
          ...
          <div className="flex space-x-5">
            ...
            <button
              onClick={submit}
              className="h-[50px] font-semibold rounded bg-bpjv w-[20%]"
              type="submit"
            >
              Submit
            </button>

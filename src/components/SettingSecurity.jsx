    ...
    <section className="w-full animate-[selection_0.5s_ease-in-out] ml-10">
      <div className="flex flex-col space-y-5">
        ...
        {user?.providerId === "google.com" && (
          <div
            id="google"
            className="w-full bg-neutral-700 p-5 rounded-md text-white"
          >
            You are connected with Google, you can&apos;t change your email or
            password.
          </div>
        )}
        <div
          ...
          <div className="w-full pr-5 border-r border-neutral-700 space-y-5">
            ...
            <div className="w-full flex justify-center items-center">
              <button
                ...
                className="h-[50px] font-semibold rounded bg-bpjv w-[30%]"
                type="button"
              >
                Submit
              </button>
        ...
        <div className="pt-10 space-y-5">
          ...
          <div className="blur cursor-not-allowed	w-full h-[20vh] rounded-xl bg-neutral-700 flex flex-col justify-center items-center space-y-5">
            <p className="text-md text-white">
              Get codes with your favorite authentication mobile application to
              secure your account
            </p>
            <button
              disabled={true}
              onClick={null}
              className="h-[50px] font-semibold rounded bg-bpjv w-[20%] cursor-not-allowed"
              type="submit"
            >
              Enable
            </button>
